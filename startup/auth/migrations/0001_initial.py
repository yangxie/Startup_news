...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'auth_userprofile', (
            ...
            ('profile_photo_url', self.gf('django.db.models.fields.CharField')(max_length=2083, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='NA', max_length=2, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True)),
    ...
    models = {
        ...
        u'auth.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile_photo_url': ('django.db.models.fields.CharField', [], {'max_length': '2083', 'blank': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'NA'", 'max_length': '2', 'blank': 'True'}),
