...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'auth_userprofile', 'state', self.gf('django.db.models.fields.CharField')(max_length=35))

    def backwards(self, orm):

        # Changing field 'UserProfile.state'
        db.alter_column(u'auth_userprofile', 'state', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        u'auth.userprofile': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "'NA'", 'max_length': '35', 'blank': 'True'}),
